...
namespace IO.Swagger.Model {
  ...
  public class RatePlanCharge {
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="FutureDatedAmendmentGroup__c", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "FutureDatedAmendmentGroup__c")]
    public string FutureDatedAmendmentGroupC { get; set; }
    ...
    /// </summary>
    /// <value> The ID of this object. Upon creation, the ID of this object is `RatePlanChargeId`. **Character limit**: 32 **Values**: automatically generated </value>
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="Notes__c", EmitDefaultValue=false)]
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="OriginalListTotal__c", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "OriginalListTotal__c")]
    public string OriginalListTotalC { get; set; }
    ...
    [JsonProperty(PropertyName = "RolloverBalance")]
    ...
    public override string ToString()  {
      ...
      sb.Append("  FutureDatedAmendmentGroupC: ").Append(FutureDatedAmendmentGroupC).Append("\n");
