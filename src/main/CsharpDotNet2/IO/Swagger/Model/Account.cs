...
namespace IO.Swagger.Model {
  ...
  public class Account {
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="AROwner__c", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "AROwner__c")]
    public string AROwnerC { get; set; }
    ...
    [JsonProperty(PropertyName = "Class__NS")]
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="CollectionsNotes__c", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "CollectionsNotes__c")]
    public string CollectionsNotesC { get; set; }
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="CustomerId__NS", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "CustomerId__NS")]
    public string CustomerIdNS { get; set; }
    ...
    [JsonProperty(PropertyName = "CustomerType__NS")]
    public string CustomerTypeNS { get; set; }
    ...
    [JsonProperty(PropertyName = "Department__NS")]
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="DryRunUntil__c", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "DryRunUntil__c")]
    public DateTime? DryRunUntilC { get; set; }

    /// <summary>
    ///  ID of object. Upon creation of this object, this field becomes `AccountId`. **Character limit**: 32 **Values**: automatically generated 
    /// </summary>
    /// <value> ID of object. Upon creation of this object, this field becomes `AccountId`. **Character limit**: 32 **Values**: automatically generated </value>
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="ImplementationID__c", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "ImplementationID__c")]
    public string ImplementationIDC { get; set; }
    ...
    [JsonProperty(PropertyName = "Location__NS")]
    ...
    [JsonProperty(PropertyName = "Subsidiary__NS")]
    ...
    [JsonProperty(PropertyName = "SynctoNetSuite__NS")]
    ...
    /// </summary>
    /// <value></value>
    [DataMember(Name="TenantId__c", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "TenantId__c")]
    public string TenantIdC { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  AROwnerC: ").Append(AROwnerC).Append("\n");
      ...
      sb.Append("  CollectionsNotesC: ").Append(CollectionsNotesC).Append("\n");
      ...
      sb.Append("  CustomerIdNS: ").Append(CustomerIdNS).Append("\n");
      ...
      sb.Append("  DryRunUntilC: ").Append(DryRunUntilC).Append("\n");
      sb.Append("  Id: ").Append(Id).Append("\n");
      sb.Append("  ImplementationIDC: ").Append(ImplementationIDC).Append("\n");
      ...
      sb.Append("  TenantIdC: ").Append(TenantIdC).Append("\n");
